...
In digital computation, the core representation format we use is a foregone conclusion. We use binary numbers! Since working 
with the real numbers is so critical to nearly every scientific endeavor, how we represent them in binary 
