...
Let's take a look at a simple illustration of where our intuition begins to fail us in high dimensions[^1]. We start with the unit interval, 
...
![1-dimensional volume](./one_dimension.png)
...
![2-dimensional volume](./two_dimensions.png)
...
![3-dimensional volume](./three_dimensions.png)
